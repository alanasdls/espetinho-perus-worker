...
const CACHE = 'espetinho-perus-v106-guest-checkout-client-access';
const PRECACHE = [
  './', './index.html', './pedido.html','./cliente.html','./cliente.css?v=20260815-v95-fidelidade-resgate','./cliente.js?v=20260920-v106-client-access', './pedido.css?v=20260724-v2', './pedido.js?v=20260724-v3', './admin.html', './admin.css?v=20260727-v79-admin-studio', './admin.js?v=20260727-v79-admin-studio', './admin-catalog.json?v=20260727-v79', './styles-v105.css?v=20260831-v105-hardwired', './app-misticpay-cpf-v102.js?v=20260920-v106-guest-checkout', './pagamento-sucesso.html', './pagamento-pendente.html', './pagamento-falhou.html',
  './manifest.webmanifest', './manifest-admin.webmanifest', './assets/banner-v105-01-10-desconto.jpg', './assets/banner-v105-02-karaoke-double.jpg', './assets/banner-v105-03-instagram-musica.jpg', './alerta-pedido.wav?v=20260724-v4', './icon-192.png', './icon-512.png', './apple-touch-icon.png',
