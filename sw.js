...
const CACHE = 'espetinho-perus-v119-signup';
const PRECACHE = [
  './', './index.html', './pedido.html','./cliente.html','./cliente.css?v=20260815-v95-fidelidade-resgate','./cliente.js?v=20260920-v119-signup', './pedido.css?v=20260724-v2', './pedido.js?v=20260724-v3', './admin.html', './admin.css?v=20260727-v79-admin-studio', './admin.js?v=20260727-v79-admin-studio', './admin-catalog.json?v=20260727-v79', './styles-v105.css?v=20260920-v119-signup', './app-misticpay-cpf-v102.js?v=20260920-v110-assets', './pagamento-sucesso.html', './pagamento-pendente.html', './pagamento-falhou.html',
